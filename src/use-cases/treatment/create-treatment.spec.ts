import { InMemoryProceduresRepository } from '@/repositories/in-memory/in-memory-procedures-repository'
...
describe('Create Treatment Use Case', () => {
  beforeEach(() => {
    ...
    sut = new CreateTreatmentUseCase(treatmentsRepository, proceduresRepository)
  })
